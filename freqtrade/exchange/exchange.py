...
class Exchange:
    ...
    def __init__(
        self, config: Config, validate: bool = True, load_leverage_tiers: bool = False
    ) -> None:
        """
    ...
    def get_rate(
        ...
        if conf_strategy.get("use_order_book", False):
            ...
            logger.debug(
                f"{pair} - {name} price from orderbook {price_side_word}"
    ...
    def _fetch_and_calculate_funding_fees(
        ...
        timeframe_ff = self._ft_has.get(
            "funding_fee_timeframe", self._ft_has["mark_ohlcv_timeframe"]
        )
        ...
        mark_comb: PairWithTimeframe = (
            pair,
            timeframe,
            CandleType.from_string(self._ft_has["mark_ohlcv_price"]),
        )
