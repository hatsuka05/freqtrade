...
class Telegram(RPCHandler):
    ...
    def _init_keyboard(self) -> None:
        ...
        # TODO: remove all keyboard from telegram
        self._keyboard = []
    ...
    def _init(self) -> None:
        ...
        # TODO: remove all command from telegram
        handles = []
    ...
    def _prepare_order_details(self, filled_orders: List, quote_currency: str, is_open: bool):
        ...
        for order in filled_orders:
            ...
            if order_nr == 1:
                ...
                lines.append(
                    f"*Average {wording} Price:* {cur_entry_average} "
    ...
    def _status_msg(self, update: Update, context: CallbackContext) -> None:
        ...
        for r in results:
            ...
            r["total_profit_abs_r"] = round_coin_value(r["total_profit_abs"], r["quote_currency"])
            lines = [
            ...
            if r["is_open"]:
                ...
                if r["open_order"]:
                    lines.append(
                        "*Open Order:* `{open_order}`" + "- `{exit_order_status}`"
    ...
    def _balance(self, update: Update, context: CallbackContext) -> None:
        ...
        starting_cap_fiat = (
            round_coin_value(result["starting_capital_fiat"], self._config["fiat_display_currency"])
